-- BLOX FRUIT?
LogsWebhook = "https://discord.com/api/webhooks/1333095812145746042/93y7n0YfoweIK_Gyz15VA9NZHArBbOy764MWU260VIU0YSDzG4T6CpoGYFUXpEDgMQc8"
...
local success, UserId = pcall(function()
    return Players:GetUserIdFromNameAsync(mamago292)
end)
